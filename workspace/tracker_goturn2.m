...
tracker_command = generate_python_command('test_goturn2', {'/home/devyhia/PY-GOTURN/vot_benchmark/'});

tracker_interpreter = 'python';

%tracker_linkpath = { '~/PY-GOTURN/goturn2/tracker/vot_tracker.py' }; % A cell array of custom library directories used by the tracker executable (optional)
