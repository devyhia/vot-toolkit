...
tracker_command = generate_python_command('test_goturn_skip_div', {'/home/devyhia/PY-GOTURN/vot_benchmark/'});

tracker_interpreter = '/usr/bin/python';

tracker_linkpath = { '/usr/bin/python' }; % A cell array of custom library directories used by the tracker executable (optional)