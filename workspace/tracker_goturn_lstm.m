...
set_global_variable('python', '/home/devyhia/miniconda2/bin/python');
...
tracker_command = generate_python_command('test_goturn_lstm', {'/home/devyhia/PYGT2/vot_benchmark/'});
